                            ...
                            <div class="card py-1 px-1 cb1 fw-bold" style="color: #000;">
                                ...
                                <div class="card-body">
                                    ...
                                    if (isset($_POST['ok'])) {
                                        ...
                                        $onlyone = "SELECT * FROM staff WHERE uname = '$email'";
                                                ...
                                                if ($len > 7) {
                                                    if ($pass == $cpass) {
                                                        if ($age >= 18) {
                                                            ...
                                                            $query = "INSERT INTO `staff`(`fname`, `mname`, `lname`,`dob`, `age`, `gender`, `c_number`, `uname`, `pass`,`img`) VALUES('$fname','$mid','$lname','$dob','$age','$gen','$cnum','$email','$hashed',
                                                '$profile')";
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input onclick="FindAge()" onmousemove="FindAge()" class="form-control mb-1" type="date" id="dob" name="dob" style="font-size :15px;" required>
                                            </div>
                                            <div class="col-md-3">

                                                <label>Age</label>
                                                <input onclick="FindAge()" onmousemove="FindAge()" class="form-control mb-1" type="number" id="age" name="age" placeholder="Enter your Age" style="font-size :15px;" required>
                                            </div>
                                            ...
                                            <div class=" modal-footer mt-3 w-100">
                                                <button onclick="FindAge()" onmousemove="FindAge()" class="btn bg-primary ms-auto text-light" name="ok" type="submit"> <label>Submit</label></button>
                                            </div>
                                        </div>
                                    </form>
