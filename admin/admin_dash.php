        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <!-- <button class="btn btn-information" type="button" data-dismiss="modal" style="color: #000;">Set Location</button> -->
                     <input class="btn btn-information" type="submit"  value="Update Default Location To Current Location">
                    <!-- <a class="btn " style="color: #000; background: skyblue;" href=".php" name="logout">Logout</a> -->
                </div>
                </form>
            </div>
        </div>
