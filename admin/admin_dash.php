...
<div class="col-xl-2 col-md-6 mb-4" style="color: #fff;">
    <div class="card shadow h-60 py-1" style="background: linear-gradient(45deg, #36b9cc, #1cc88a);">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="fw-bold text-white text-uppercase mb-1" style="font-size: 0.8em;">
...
<div class="col-md-3 mb-4" style="color: #fff;">
    <div class="card shadow h-60 py-1" style="background: linear-gradient(45deg, #4e73df, #f6c23e);">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="fw-bold text-white text-uppercase mb-1" style="font-size: 0.8em;">
...
<div class="col-md-2 mb-4" style="color: #fff;">
    <div class="card shadow h-60 py-1" style="background: linear-gradient(45deg, #ff5733, #f6c23e);">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="fw-bold text-white text-uppercase mb-1" style="font-size: 0.8em;">
...
<div class="col-md-3 mb-4" style="color: #fff;">
    <div class="card shadow h-60 py-1" style="background: linear-gradient(45deg, #ffb142, #ff5733);">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="fw-bold text-white text-uppercase mb-1" style="font-size: 0.8em;">
