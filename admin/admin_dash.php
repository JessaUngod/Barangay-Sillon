    ...
    <div class="main-container-fluid d-flex">
        <div class="sidebar" id="side_nav">
           ...
           <ul class="list-unstyled px-3">
                <li class="active"><a href="../admin/admin_dash.php" class="text-decoration-none px-3 py-2 d-block" style="color: #000;"> <i class="fas fa-home"></i> Dashboard</a></li>
                <li class=""><a href="../admin/employee.php" class="text-decoration-none px-3 py-2 d-block" style="color: #000;"> <i class="fas fa-users"></i> Employees</a></li>
                <li class=""><a href="../admin/employee_payroll.php" class="text-decoration-none px-3 py-2 d-block" style="color: #000;"> <i class="fas fa-pencil"></i> Payroll</a></li>
                <li class=""><a href="../admin/payroll_rec.php" class="text-decoration-none px-3 py-2 d-block" style="color: #000;"> <i class="fas fa-book-open"></i> Reports</a></li>
                <li class=""><a href="../admin/posistion.php" class="text-decoration-none px-3 py-2 d-block" style="color: #000;"> <i class="fas fa-bar-chart"></i> Positions</a></li>
                <li class=""><a href="../admin/accounts.php" class="text-decoration-none px-3 py-2 d-block" style="color: #000;"> <i class="fas fa-user"></i> Accounts</a></li>
                <li class=""><a href="../admin/log_rec.php" class="text-decoration-none px-3 py-2 d-block" style="color: #000;"><i class="fas fa-clock"></i> Login / Logout</a></li>
            </ul>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between d-md-none d-block">
                       ...
                       <strong style="font-size:22px; color: #000;"><strong style="font-size: 28px;">a</strong>dmin</strong></a>
                    </div>
