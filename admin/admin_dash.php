...
/* Change sidebar links color */
.sidebar a {
    color: #ffffff; /* White */
    transition: background-color 0.3s;
}

/* Change hover effect on sidebar links */
.sidebar a:hover {
    background-color: #3A99D7; /* Light Blue */
}
...
/* Modify card header font color */
.card-header {
    background-color: #f1f1f1; /* Light gray */
    color: #333333; /* Dark text */
}

/* Modify chart labels or buttons */
button, .btn {
    background-color: #3A99D7; /* Light Blue */
    color: #ffffff;
}
...
button:hover, .btn:hover {
    background-color: #007B8C; /* Darker Blue on hover */
}

/* Modify the topbar text color */
.topbar {
...
/* Change font color for headings */
h1, h2, .fw-bold {
    color: #333333;
}

/* Modify footer text color */
footer {
    color: #ffffff;
}
