    ...
    <div class="main-container-fluid d-flex">
        <div class="sidebar" id="side_nav">
           ...
           <ul class="list-unstyled px-3">
                ...
                <li class="active"><a href="../admin/employee_payroll.php" class="text-decoration-none px-3 py-2 d-block"> <i class="fas fa-pencil"></i> Payroll</a></li>
...
if(!empty($_SESSION['idadmins'])){
   ...
   <div class="container-fluid">
                           ...
                           <h1 class=" fw-bold mb-0 text-gray-800 fs-3 mb-4" style="color: #000;"><strong>Payroll</strong></h1>
                ...
                <div class="row">
                       ...
                       <div class="card shadow mb-3 p-1">
                        <div class="card-header">
                            <h6 class="m-0  fw-bold" style="color: #000;"><strong style="font-size: 28px;">Employee Info   </strong></h6>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover" id="myTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody style="color: #000;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"> <a title="Payroll" class="btn btn-primary " href="payslip.php?employeepay_id=<?php echo $row1['emp_id'];?>">Payroll</a> </td>
