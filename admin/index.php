		...
		<div class="col-8">
			<div class="card rounded" >
				<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-6" style=" background: url(../assets/img/sillon.jpg); background-size: cover; background-repeat: no-repeat	; background-position: center; height: 500px; width: 500px; margin-left: 50px;">
