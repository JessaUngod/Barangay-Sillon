				...
				<?php 
                  if(isset($_POST['login'])){
                   ...
                   ?>
								...
								<input class="form-control" type="password" name="password" id="pass" placeholder="Enter password" autocomplete="off"><i class="fa fa-eye-slash" style="position: fixed; margin-top: 10px; margin-left: 25px; color: lightgray;"  onclick="myfunction()" id="iconic"></i>
