    ...
    <div class="main-container-fluid d-flex">
        <div class="sidebar" id="side_nav">
           ...
           <ul class="list-unstyled px-3">
                ...
                <li class="active"><a href="../admin/log_rec.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-clock"></i> Login / Logout</a></li>
...
?> 
   ...
   <div class="container-fluid">
                           ...
                           <h1 class=" fw-bold mb-0 text-gray-800 fs-3 mb-4" style="color: #000;"><strong>Employee</strong></h1>
                ...
                <div class="row">
                       ...
                       <div class="card shadow mb-3 p-1">
                        <div class="card-header">
                            <h6 class="m-0  fw-bold" style="color: #000;"><strong style="font-size: 28px;"> Login/Logout Records   </strong></h6>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover" id="myTable" width="100%" cellspacing="0">
                                    <thead style="font-size: 1em; color: #fff;">
                                        ...
                                        <tr>
                                            ...
                                            <th class="fw-bold bg-primary ">Staff Name</th>
                                            <th class="fw-bold bg-primary ">Login Time</th>
                                            <th class="fw-bold bg-primary ">Logout Time</th>
                                    ...
                                    <tbody style="color: #000;">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  date("F d, Y h:i:A",strtotime($row1['login'])); ?></td>
                                            <td><?php if ($row1['logout']== null) {
                                                echo "<p class = 'text-danger fw-bold'>This Staff has not Logout yet</p>";
                                            }else{
                                                echo $row1['logout'];
                                            } ?></td>
