                 ...
                 <div class="row">
                       <div class="card shadow mb-3 p-1">
                        <div class="card-header">
                            <h6 class="m-0  fw-bold" style="color: #000;"><strong style="font-size: 30px;"> Staff  </strong><a class="btn btn-primary" href="add_staff.php" style="color: #fff;"><i class="fas fa-add fs-7" style="color: #8e44ad;"></i><strong class="fs-7">  Add Staff</strong></a></h6>
                        </div>
                        </div>
