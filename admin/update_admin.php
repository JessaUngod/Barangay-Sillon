                        ...
                        <div class="col-md-8 mb-3">
                            <div class="card py-1 px-1 cb1 fw-bold" style="color: #000;">
                                ...
                                if (isset($_GET['admin_id'])) {
                                    $getadmin_id = $_GET['admin_id'];

                                    $sql = "SELECT * FROM admin WHERE id ='$getadmin_id'";
                                    ...
                                    if (isset($_POST['update'])) {
                                        ...
                                        if ($_FILES['profile']['error'] > 0) {
                                            if (empty($pass)) {
                                                ...
                                                $query = "UPDATE `admin` SET `fname`='$fname',`mname`='$mid',`lname`='$lname',`age`='$age',`gender`='$gen',`uname`='$email' WHERE id = '$getadmin_id'";

                                                if (mysqli_query($con, $query)) {
                                                    ?>
                                                        <script>
                                                            window.location = "./admin.php?msgadmin=adminupdate";
                                                        </script>
                                                    <?php
                                                }
                                                ...
                                                if (strlen($pass) < 8) {
                                                    ...
                                                    $query = "UPDATE `admin` SET `fname`='$fname',`mname`='$mid',`lname`='$lname',`age`='$age',`gender`='$gen',`uname`='$email',`pass`='$hashed' WHERE id = '$getadmin_id'";
                                            ...
                                            if (empty($pass)) {
                                                ...
                                                $query = "UPDATE `admin` SET `fname`='$fname',`mname`='$mid',`lname`='$lname',`age`='$age',`gender`='$gen',`uname`='$email',`img`='$profile' WHERE id = '$getadmin_id'";
                                                ...
                                                if (strlen($pass) < 8) {
                                                    ...
                                                    $query = "UPDATE `admin` SET `fname`='$fname',`mname`='$mid',`lname`='$lname',`age`='$age',`gender`='$gen',`uname`='$email',`pass`='$pass',`img`='$profile' WHERE id = '$getadmin_id'";
                                        ...
                                        //                 $query = "UPDATE `admin` SET `fname`='$fname',`mname`='$mid',`lname`='$lname',`age`='$age',`gender`='$gen',`uname`='$email',`pass`='$pass' WHERE id = '$getadmin_id'";
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <label>Age</label>
                                                <input class="form-control mb-1" type="number" name="age" placeholder="Enter your Age" style="font-size :15px;" required value="<?php echo $rower['age']; ?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control mb-1" type="password" id="pass" name="pass" placeholder="Enter Password" autocomplete="off" style="font-size :15px;"><i class="fa fa-eye-slash" style="position: absolute; top: 64%; right: 52%; color: lightgray;" onclick="myfunction()" id="iconic"></i>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Re - Password</label>
                                                <input class="form-control mb-1" type="password" autocomplete="off" id="rpass" name="cpass" placeholder="Enter Re - Password" style="font-size :15px;"><i class="fa fa-eye-slash" style="position: absolute; top: 64%; right: 4%; color: lightgray;" onclick="myfunction2()" id="icon"></i>
                                            </div>
                                            <center>
                                                <div class="col-md-8">
                                            ...
                                            <div class=" modal-footer mt-3 w-100">
                                                <button class="btn bg-success ms-auto text-light" name="update" type="submit"> <label>Update</label></button>
                                            </div>
                                        </div>
                                    </form>
