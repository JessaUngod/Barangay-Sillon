                ...
                if (!empty($idemp)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        if (mysqli_num_rows($results) > 0) {
                            ...
                            $curr_time = (int)date('h');
                            $curr_time_period = date('A');
                            $valid_out_time = 05;
                            $valid_period = "PM";
                            ...
                            <div class="bg-transparent" style="width: 100%;">
                                ...
                                <form class="form" method="post" autocomplete="off">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4"></div>
                                            <div class="col-md-12"><strong class="fs-6">Employee ID</strong></div>
                                            <div class="col-md-4"></div>
                                            <div class="col-md-1"></div>
                                            <div class="col-md-12"><input type="text" name="inputid" placeholder="Enter Employee ID" class="form-control" style="background: #fff; border-radius: 7px;"></div>
