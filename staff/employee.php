...
<body>
    ...
    <?php 
    if (isset($_GET['msgupdate'])=="updated") {
    echo '<script>swal("UPDATE SUCCESSFULLY !", "Employee Updated", "success")</script>';
}
                ...
                <div class="row">
                       ...
                       <div class="card shadow mb-3 p-1">
                        <div class="card-header">
                            <h6 class="m-0  fw-bold" style="color: #000;"><strong style="font-size: 28px;">Employee Info   </strong><a class="btn btn-primary" href="add_emp.php" style="color: #fff;"><i class="fas fa-add fs-7" style="color: #fff;"></i><strong class="fs-7">  Add Employee   </strong></a></h6>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel"><strong>Delete Employee</strong></h5>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger " style="color: #fff;" name="delete1" value="<?php echo $row1['emp_id'];?>">Delete</button>
